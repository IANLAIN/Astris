...
export const CONTENT = {
  es: {
    aboutPage: {
      ...
      heroSub: "",
      heroQuote: "Nos adaptamos a ti para conectar tu potencial con el lugar donde puede brillar.",
      heroDesc: "",
      purposeLabel: "Propósito",
      purposeTitle: "Propósito",
      purposeBody: "Conectar capacidades con entornos reales.",
      missionLabel: "Misión",
      missionTitle: "Puentes entre talento y oportunidad",
      missionBody: "Ajustar procesos sin filtros ni etiquetas.",
      visionLabel: "Visión",
      visionTitle: "Un mundo laboral sin barreras",
      visionBody: "Diversidad cognitiva como motor de innovación.",
      philosophyTitle: "Nuestra Filosofía",
      philosophyDesc: "Nos adaptamos a ti para conectar tu potencial con el lugar donde puede brillar.",
  ...
  en: {
    aboutPage: {
      ...
      purposeBody: "Connecting capabilities with real environments.",
      missionLabel: "Mission",
      missionTitle: "Bridges between talent and opportunity",
      missionBody: "Adjusting processes without filters or labels.",
      visionLabel: "Vision",
      visionTitle: "A world of work without barriers",
      visionBody: "Cognitive diversity as an innovation engine.",
      philosophyTitle: "Our Philosophy",
      philosophyDesc: "We adapt to you to connect your potential with the place where it can shine.",
  ...
  pt: {
    aboutPage: {
      ...
      purposeLabel: "Propósito",
      purposeTitle: "Propósito",
      purposeBody: "Conectar capacidades com ambientes reais.",
      missionLabel: "Missão",
      missionTitle: "Pontes entre talento e oportunidade",
      missionBody: "Ajustar processos sem filtros ou rótulos.",
      visionLabel: "Visão",
      visionTitle: "Um mundo laboral sem barreiras",
      visionBody: "Diversidade cognitiva como motor de inovação.",
      philosophyTitle: "Nossa Filosofia",
      philosophyDesc: "Nos adaptamos a você para conectar seu potencial com o lugar onde ele pode brilhar.",
  ...
  fr: {
    aboutPage: {
      ...
      purposeBody: "Connecter les capacités aux environnements réels.",
      missionLabel: "Mission",
      missionTitle: "Des ponts entre talent et opportunité",
      missionBody: "Ajuster les processus sans filtres ni étiquettes.",
      visionLabel: "Vision",
      visionTitle: "Un monde du travail sans barrières",
      visionBody: "La diversité cognitive comme moteur d'innovation.",
      philosophyTitle: "Notre Philosophie",
      philosophyDesc: "Nous nous adaptons à vous pour connecter votre potentiel à l'endroit où il peut briller.",

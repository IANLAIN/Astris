...
export const T: Record<Lang, Record<string, any>> = {
  es: {
    ...
    "dash.suggested": "Vacantes sugeridas",
    "dash.matches": "Matches de perfil",
    "dash.mentor": "Acompañamiento",
    "dash.active": "Activo",
    "landing.nav.about": "Sobre Astris",
    "landing.nav.support": "Soporte",
    "landing.nav.partners": "Partners",
    "landing.nav.login": "Iniciar Sesión",
    "landing.nav.register": "Comenzar",
    "landing.hero.t1": "Nos adaptamos a ti",
    "landing.hero.t2": "para conectar tu potencial con el lugar donde puede brillar.",
    "landing.hero.sub": "",
    ...
    "landing.footer.program": "Nos adaptamos a ti para conectar tu potencial con el lugar donde puede brillar.",
    "back": "Atrás",
    "next": "Siguiente",
    "continue": "Continuar",
  ...
  en: {
    ...
    "dash.suggested": "Suggested Vacancies",
    "dash.matches": "Profile Matches",
    "dash.mentor": "Mentorship",
    "dash.active": "Active",
  ...
  pt: {
    ...
    "dash.suggested": "Vagas sugeridas",
    "dash.matches": "Matches de perfil",
    "dash.mentor": "Acompanhamento",
    "dash.active": "Ativo",
  ...
  fr: {
    ...
    "dash.suggested": "Postes suggérés",
    "dash.matches": "Correspondances",
    "dash.mentor": "Accompagnement",
    "dash.active": "Actif",
...
export const CONTENT = {
  es: {
    aboutPage: {
      ...
      purposeTitle: "Derecho, no privilegio",
      purposeBody: "Garantizar que el empleo sea un derecho, no un privilegio. Facilitamos una inserción laboral inclusiva acompañando a las personas neurodivergentes a potenciar sus capacidades y ayudando a las empresas a construir espacios donde todas las formas de pensar y aprender sean valoradas.",
      missionLabel: "Misión",
      missionTitle: "El puente del talento",
      missionBody: "Ser el puente entre el talento neurodivergente y las empresas comprometidas con la inclusión. A través de nuestra plataforma: formamos y acompañamos a los candidatos; sensibilizamos a las organizaciones para lograr procesos de selección más equitativos. Nota central: No adaptamos a las personas a sistemas excluyentes; transformamos los espacios de trabajo para aprovechar la riqueza de la diversidad cognitiva.",
      visionLabel: "Visión",
      visionTitle: "Plataforma referente para 2036",
      visionBody: "Para el año 2036, ser la plataforma referente en inclusión laboral y neurodiversidad. Visualizamos un mundo sin barreras ni prejuicios, donde la diversidad cognitiva sea reconocida como un motor de innovación y creatividad. Aspiramos a una sociedad donde cada persona encuentre un empleo digno que impulse su bienestar y autonomía, y donde las empresas ofrezcan entornos más humanos y accesibles para todos.",
  ...
  en: {
    aboutPage: {
      ...
      purposeTitle: "Right, not privilege",
      purposeBody: "To guarantee that employment is a right, not a privilege. We facilitate inclusive labor market insertion by accompanying neurodivergent individuals to enhance their capabilities and helping companies build spaces where all ways of thinking and learning are valued.",
      missionLabel: "Mission",
      missionTitle: "The bridge of talent",
      missionBody: "To be the bridge between neurodivergent talent and companies committed to inclusion. Through our platform: we train and accompany candidates; we raise awareness among organizations to achieve more equitable selection processes. Core note: We do not adapt people to exclusionary systems; we transform workspaces to leverage the wealth of cognitive diversity.",
      visionLabel: "Vision",
      visionTitle: "Leading platform by 2036",
      visionBody: "By 2036, to be the leading platform in labor inclusion and neurodiversity. We envision a world without barriers or prejudices, where cognitive diversity is recognized as an engine of innovation and creativity. We aspire to a society where each person finds dignified employment that boosts their well-being and autonomy, and where companies offer more human and accessible environments for all.",
  ...
  pt: {
    aboutPage: {
      ...
      heroDesc: "",
      purposeLabel: "Propósito",
      purposeTitle: "Direito, não privilégio",
      purposeBody: "Garantir que o emprego seja um direito, não um privilégio. Facilitamos uma inserção laboral inclusiva, acompanhando pessoas neurodivergentes para potencializar suas capacidades e ajudando as empresas a construir espaços onde todas as formas de pensar e aprender sejam valorizadas.",
      missionLabel: "Missão",
      missionTitle: "A ponte do talento",
      missionBody: "Ser a ponte entre o talento neurodivergente e as empresas comprometidas com a inclusão. Através de nossa plataforma: formamos e acompanhamos os candidatos; sensibilizamos as organizações para alcançar processos de seleção mais equitativos. Nota central: Não adaptamos as pessoas a sistemas excludentes; transformamos os espaços de trabalho para aproveitar a riqueza da diversidade cognitiva.",
      visionLabel: "Visão",
      visionTitle: "Plataforma de referência até 2036",
      visionBody: "Até 2036, ser a plataforma de referência em inclusão laboral e neurodiversidade. Visualizamos um mundo sem barreiras ou preconceitos, onde a diversidade cognitiva seja reconhecida como um motor de inovação e criatividade. Aspiramos a uma sociedade onde cada pessoa encontre um emprego digno que impulsione seu bem-estar e autonomia, e onde as empresas ofereçam ambientes mais humanos e acessíveis para todos.",
  ...
  fr: {
    aboutPage: {
      ...
      purposeTitle: "Droit, non privilège",
      purposeBody: "Garantir que l'emploi soit un droit, non un privilège. Nous facilitons une insertion professionnelle inclusive en accompagnant les personnes neurodivergentes pour renforcer leurs capacités et en aidant les entreprises à construire des espaces où toutes les façons de penser et d'apprendre sont valorisées.",
      missionLabel: "Mission",
      missionTitle: "Le pont du talent",
      missionBody: "Être le pont entre le talent neurodivergent et les entreprises engagées dans l'inclusion. À travers notre plateforme : nous formons et accompagnons les candidats; nous sensibilisons les organisations pour parvenir à des processus de sélection plus équitables. Note centrale : Nous n'adaptons pas les personnes à des systèmes exclusifs ; nous transformons les espaces de travail pour tirer parti de la richesse de la diversité cognitive.",
      visionLabel: "Vision",
      visionTitle: "Plateforme de référence d'ici 2036",
      visionBody: "D'ici 2036, être la plateforme de référence en matière d'inclusion professionnelle et de neurodiversité. Nous envisageons un monde sans barrières ni préjugés, où la diversité cognitive est reconnue comme un moteur d'innovation et de créativité. Nous aspirons à une société où chaque personne trouve un emploi digne qui stimule son bien-être et son autonomie, et où les entreprises offrent des environnements plus humains et accessibles à tous.",
